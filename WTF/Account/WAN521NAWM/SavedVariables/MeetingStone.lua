...
MEETINGSTONE_UI_DB = {
	...
	["global"] = {
		...
		["serverDatas"] = {
			...
			["ActivitiesData"] = {
				["data"] = "$1$Z$S217`魔兽主播活动`决战达萨罗（部落）`4月13日（周六）20点，决战达萨罗（部落）*J联盟舰队从达萨罗撤退的时候，吉安娜与几只科尔提拉斯舰船一同殿后，想借此拖住部落追击的步伐。让我们与斗鱼TV：近战之光喵妮莎（房间号：37625）一起协助部落的士兵，击溃吉安娜的防御！*J魔兽主播活动QQ交流群：603459231`http://w.163.com/special/convene-stone/`1`3$S218`魔兽主播活动`突袭风暴熔炉（部落）`4月20日（周六）22：30，突袭风暴熔炉（部落）*J潜藏已久的邪恶之力正在风暴神殿下方蠢蠢欲动，深渊中回响着包含诡谲之力的海妖之歌。不管他们狂热的行动是为了实现何种梦魇般的计划，快和斗鱼TV：炎凉大宝宝（房间号：128314）一起阻止他们！*J魔兽主播活动QQ交流群：603459231`http://w.163.com/special/convene-stone/`1`3$$",
			},
		},
		["version"] = "80100.04",
	},
