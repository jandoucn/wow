...
MEETINGSTONE_UI_DB = {
	["profileKeys"] = {
		["Feigndeath - 影之哀伤"] = "Default",
		["Discpriest - 影之哀伤"] = "Default",
		["Lo - 熊猫酒仙"] = "Default",
	},
	["global"] = {
		["spamWord"] = {
		...
		["serverDatas"] = {
			...
			["ActivitiesData"] = {
				["data"] = "$1$Z$S218`魔兽主播活动`突袭风暴熔炉（部落）`4月20日（周六）22：30，突袭风暴熔炉（部落）*J潜藏已久的邪恶之力正在风暴神殿下方蠢蠢欲动，深渊中回响着包含诡谲之力的海妖之歌。不管他们狂热的行动是为了实现何种梦魇般的计划，快和斗鱼TV：炎凉大宝宝（房间号：128314）一起阻止他们！*J魔兽主播活动QQ交流群：603459231`http://w.163.com/special/convene-stone/`1`3$$",
			},
		},
		["version"] = "80100.04",
		["filters"] = {
